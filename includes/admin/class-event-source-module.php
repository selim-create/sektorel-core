...
class Sektorel_Event_Source_Module {
    ...
    public static function init() {
        ...
        Sektorel_Event_Source_Stage_Registry::register( array(
            ...
            'description'      => 'KOSGEB, İŞKUR, TÜBİTAK, Kalkınma Ajansları, Ticaret Bakanlığı, Türk Eximbank, TKDK/IPARD ve Dijital Avrupa resmî kaynaklarını kaynağa özel deterministic/canlı adapterlarla tarar; doğrulanmış açık/yaklaşan fırsatları taslak Event olarak günceller.',
        ...
        require_once __DIR__ . '/class-event-verified-source-repair-stage.php';
        Sektorel_Event_Verified_Source_Repair_Stage::init();
