...
class Sektorel_Event_Source_Module {
    ...
    public static function init() {
        ...
        Sektorel_Event_Source_Stage_Registry::register( array(
            ...
            'description'      => 'KOSGEB, İŞKUR, TÜBİTAK, Kalkınma Ajansları, Ticaret Bakanlığı, Türk Eximbank ve TKDK/IPARD resmî kaynaklarını kaynağa özel deterministic/canlı adapterlarla tarar; doğrulanmış açık/yaklaşan fırsatları taslak Event olarak günceller.',
